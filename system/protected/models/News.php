...
class News extends CActiveRecord {
    ...
    function getInforPage() {
        ...
        $msgFirst = '';
        $msgSecond = '';
        $title = '<p style="font-family: Arial;font-size: 13px;font-weight: bold;">' . $this->title . ' <a target="_blank" style="color: red;font-size: 12px;padding-left: 10px;" href="http://localhost/evaxinh/page/'.$this->alias.'">[Xem Trang...]</a></p>';
        ...
        return $title.$msgHeader.$msgFirst. $msgSecond;
    }
    ...
    function setExplain() {
        return '<a class="label label-primary" href="'.Yii::app()->createUrl('explaindata/create', array('news_id' => $this->id)).'">Thêm dữ liệu bổ sung</a>';
    }
    ...
    public function rules() {
        ...
        $rules = array(
            ...
            array('view, hot, status, is_page', 'numerical', 'integerOnly' => true),

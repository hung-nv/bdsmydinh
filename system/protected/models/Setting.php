 ...
 * @property string $account_send
 * @property string $password_send
 */
class Setting extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('meta_title, meta_description, meta_keywords, address, logo, favico, fanpage, youtube, name, description, why_me_label, promotion_label, promotion_content, mail_to, account_send, password_send', 'length', 'max' => 255),
    ...
    public function attributeLabels() {
        return array(
            ...
            'mail_to' => 'Mail to',
            'account_send' => 'Account Send Mail',
            'password_send' => 'Password Send Mail',
        );
    }

        ...
        <div class="col-md-12">
            <div class="box box-info">
                <div class="box-header">
                    <h3 class="box-title">Why me? + Promotion</h3>                                    
                </div>

                <div class="box-body">

                    <div class="form-group">
                        <?php echo $form->labelEx($model, 'promotion_label'); ?>
                        <?php echo $form->textField($model, 'promotion_label', array('class' => 'form-control')); ?>
                        <div class="help-block with-errors"></div>
                    </div>

                    <div class="form-group">
                        <?php echo $form->labelEx($model, 'promotion_content'); ?>
                        <?php echo $form->textField($model, 'promotion_content', array('class' => 'form-control')); ?>
                        <div class="help-block with-errors"></div>
                    </div>
